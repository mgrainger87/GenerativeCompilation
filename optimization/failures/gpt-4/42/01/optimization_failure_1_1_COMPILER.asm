...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpctyfk4xx-b692cd.s:24:1: error: Invalid relocation on conditional branch!
; tbnz w8, #0, continue_loop ; If w8 is not 0 (int1 > 0), continue with loop
; ^
; 
; ; Linker error: None
...
.cfi_startproc
; %bb.0:
sub    sp, sp, #32                        ; Adjust stack for 32 bytes (we reduced the space since we removed int2 and double2)
