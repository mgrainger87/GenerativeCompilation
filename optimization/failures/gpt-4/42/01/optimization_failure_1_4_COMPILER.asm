; solution_number=1,compiler_errors=4,linker_errors=0,execution_errors=0,correctness_errors=0
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpi3ni90_a-e28242.s:25:1: error: conditional branch requires assembler-local label. 'exit_loop' is external.
; beq exit_loop ; If w8 is 0, branch to exit_loop
; ^
; 
; ; Linker error: None
...
beq     exit_loop                         ; If w8 is 0, branch to exit_loop
b      continue_loop                      ; Else branch to continue_loop
