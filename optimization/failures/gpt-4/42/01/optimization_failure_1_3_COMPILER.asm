; solution_number=1,compiler_errors=3,linker_errors=0,execution_errors=0,correctness_errors=0
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpup5tvpqg-bbf1e6.s:24:1: error: Invalid relocation on conditional branch!
; tbz w8, #0, short_exit ; If w8 is 0, branch to short_exit
; ^
; 
; ; Linker error: None
