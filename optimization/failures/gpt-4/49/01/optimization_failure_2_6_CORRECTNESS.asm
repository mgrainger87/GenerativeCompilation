; solution_number=2,compiler_errors=2,linker_errors=0,execution_errors=2,correctness_errors=2
; ; Compiler error: None
; ; Linker error: None
...
ldr	d0, [sp, #16]  ; load double1 (this was missing in the previous assembly)
ldr	x8, [sp, #8]
str	d0, [x8]
b	99f
