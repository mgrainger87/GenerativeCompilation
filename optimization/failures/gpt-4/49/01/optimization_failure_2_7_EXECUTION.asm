; solution_number=2,compiler_errors=2,linker_errors=0,execution_errors=3,correctness_errors=2
; ; Compiler error: None
; ; Linker error: None
...
; d5 = 50
; d6 = 1.0467824234365535E+145
; d7 = -1.4359090370881043E+51
; d8 = 0
; d9 = 0
; d10 = 0
; d11 = 0
...
; d19 = 0
; d20 = -5.1233804596675606E-209
; d21 = 6.4492723389023216E-233
; d22 = -6.0127406502446862E+283
; d23 = 1.3113584278893775E-123
; d24 = -3.5366417119160715E+152
; d25 = 1.2824367927088275E+174
; d26 = -8.941239341603957E+39
; d27 = -3.5403477938164502E+224
; d28 = 2.8030743456514195E+240
; d29 = -2.3520285746550265E+100
; d30 = 5.6179158112077325E-226
; d31 = 0
; far = 0x0000000100003a28
; esr = 0x9200004f
; exception = 0x00000000
; Thread 1 Stop Reason: EXC_BAD_ACCESS (code=2, address=0x100003a28)
; Thread 19168863 Backtrace:
; frame #0: [33m0x0000000100003900[0m tmpwlv14e9t`___lldb_unnamed_symbol9 + 28
; frame #1: [33m0x0000000100003c50[0m tmpwlv14e9t`main + 552
; frame #2: [33m0x0000000100003c50[0m tmpwlv14e9t`main + 552
...
ldr	d5, [x8, lCPI0_0@PAGEOFF]
fcmp	d1, d5
b.le	99f

// Set outDouble to double1
ldr	d0, [sp, #16]  ; load double1 (corrected)
ldr	x8, [sp, #8]
str	d0, [x8]
b	99f
