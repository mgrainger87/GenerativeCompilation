...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpzz4etivb-ae2770.s:25:1: error: conditional branch requires assembler-local label. '.LRecursiveCall' is external.
; ble .LRecursiveCall ; If difference is not > 10, jump to recursive call
; ^
; 
; ; Linker error: None
