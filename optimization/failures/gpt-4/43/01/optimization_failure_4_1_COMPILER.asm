...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpbdfnaohw.asm:22:15: error: unexpected floating point literal
; fsub d0, d0, #2.00000000 ; Subtract 2.0 directly to effectively add only 2.0 to double1
;               ^
; 
; ; Linker error: None
