...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp9hv4khbw-aa23ee.s:23:1: error: conditional branch requires assembler-local label. 'recursive_branch' is external.
; b.lt recursive_branch ; If double1 < 10.0, jump to recursive_branch
; ^
; 
; ; Linker error: None
