...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp0hv9x82h.asm:37:1: error: unrecognized instruction mnemonic, did you mean: st1, st2, st3, st4, stadd, stp, str, tst?
; std d0, [x6]
; ^
; 
; ; Linker error: None
...
std d0, [x6]            // Store double1 in *outDouble
