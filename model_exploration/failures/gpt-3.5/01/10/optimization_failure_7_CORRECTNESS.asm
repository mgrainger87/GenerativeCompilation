; compiler_errors=1,linker_errors=1,execution_errors=1,correctness_errors=4
; ; Compiler error: None
; ; Linker error: None
...
ldr	w0, [x29, #12]    // Load int1 from the stack frame
ldr	x1, [x29, #8]     // Load int2 from the stack frame
ldr	d0, [x29, #16]    // Load double1 from the stack frame
ldr	x2, [x29, #24]    // Load double2 from the stack frame
