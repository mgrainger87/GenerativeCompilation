...
_customFunction:
    ...
    // Compute *outInt using constant folding
    add     w8, w0, w0       // w8 = int1 * 2
    add     w9, w1, w1       // w9 = int2 * 2
    add     w9, w9, w1       // w9 = int2 * 3
    add     w8, w8, w9       // w8 = int1 * 2 + int2 * 3
    add     w8, w8, #10      // w8 = int1 * 2 + int2 * 3 + 10 (constant folding not applicable here)
    str     w8, [x4]         // Store w8 to *outInt

    // Compute *outDouble (constant folding not applicable here)
