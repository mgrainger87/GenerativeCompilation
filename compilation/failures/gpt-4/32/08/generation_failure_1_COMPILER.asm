...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpwt9fl3rf.asm:13:15: error: unexpected floating point literal
; fadd d1, d1, #1.0
;               ^
; 
; ; Linker error: None
...
// Increment int1 (x0) and double2 (d1) and decrement int2 (x1)
add x0, x0, #1
add x1, x1, #-1
fadd d1, d1, #1.0
