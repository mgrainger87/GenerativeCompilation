...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmphuyc55ap.asm:16:11: error: expect relocation specifier in operand after ':'
; adrp x4, :page:one_point_zero
;           ^
; 
; ; Linker error: None
