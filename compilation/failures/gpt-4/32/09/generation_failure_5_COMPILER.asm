...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp7qow4jt_.asm:16:10: error: invalid operand for instruction
; ldr d2, [pc, #one_point_zero]
;          ^
; 
; ; Linker error: None
...
// Offset to 1.0 constant in the pool
one_point_zero: .word one_point_zero_data - .
