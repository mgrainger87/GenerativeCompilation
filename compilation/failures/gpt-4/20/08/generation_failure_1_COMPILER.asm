...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1xjvnswr.asm:14:6: error: unexpected floating point literal
; b.gt .1
;      ^
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1xjvnswr.asm:22:1: error: unexpected token at start of statement
; .1:
; ^
; 
; ; Linker error: None
