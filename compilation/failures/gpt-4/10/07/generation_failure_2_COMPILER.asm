...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpnfcbutq0.asm:16:14: error: index must be an integer in range [-256, 255].
; ldr d5, [x5, five_point_0]
;              ^
; 
; ; Linker error: None
...
ldr  d5, [x5, five_point_0] // Load the constant into d5
