...
; Thread 15399602 Backtrace:
; frame #0: [33m0x0000000100003964[0m tmp3t6e3822`customFunction + 8
; 
; ; Correctness error: None
.global _helperFunction
_helperFunction:
// Multiply a by itself and return
fmul d0, d0, d0
ret
.global _customFunction
_customFunction:
// Store int1 at outInt address
str w0, [x2]

// Call helperFunction with double1
bl _helperFunction

// Store the result of helperFunction at outDouble address
str d0, [x3]
