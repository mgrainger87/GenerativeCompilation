...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp2w2gfn1s-9194f7.s:16:1: error: ADR/ADRP relocations must be GOT relative
; adrp x4, float_constant
; ^
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp2w2gfn1s-9194f7.s:16:1: error: unknown AArch64 fixup kind!
; adrp x4, float_constant
; ^
; 
; ; Linker error: None
