...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp8_t1fymq.asm:1:15: error: unexpected token in '.section' directive
; .section .data
;               ^
; 
; ; Linker error: None
...
ldr     d4, fp_const     // Load 0.1 into register D4
