; compiler_errors=2,linker_errors=0,execution_errors=0,correctness_errors=3
; ; Compiler error: None
; ; Linker error: None
...
ldr w19, [sp, #8]            // Load int2 into w19
add w19, w19, w0             // w19 = int1 + int2. This line was incorrect in the previous assembly.
