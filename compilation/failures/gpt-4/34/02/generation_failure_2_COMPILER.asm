...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmptevss2vm.asm:10:9: error: Immediate too large for register
; ldr d8, =0.5
;         ^
; 
; ; Linker error: None
...
stp x29, x30, [sp, -32]! // Store FP (x29) and LR (x30) to the stack and decrement SP by 32 bytes for some additional space
mov x29, sp             // Update FP with the current SP

// Load floating point values
ldr d8, =0.5            // Load 0.5 into d8
