...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpzri_njkb.asm:21:14: error: invalid operand for instruction
; fadd d1, d1, v0
;              ^
; 
; ; Linker error: None
...
fadd d1, d1, v0            // Corrected here: d1 = d1 + double1
