...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpeoy5vmll-0a028a.s:20:1: error: ADR/ADRP relocations must be GOT relative
; adrp x4, :got:one_point_zero
; ^
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpeoy5vmll-0a028a.s:20:1: error: unknown AArch64 fixup kind!
; adrp x4, :got:one_point_zero
; ^
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpeoy5vmll-0a028a.s:21:1: error: unknown AArch64 fixup kind!
; ldr d2, [x4, :got_lo12:one_point_zero]
; ^
; 
; ; Linker error: None
