; compiler_errors=0,linker_errors=1,execution_errors=3,correctness_errors=2
; ; Compiler error: None
; ; Linker error: None
...
str w0, [x4]                // Store int1 into *outInt
...
cbnz x4, perform_increment  // If x4 (outInt) is not NULL, proceed to increment
skip_increment:
add w6, w6, #1              // i++
...
b skip_increment            // Jump back to skip_increment
