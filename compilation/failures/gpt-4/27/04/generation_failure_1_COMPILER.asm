...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpape29v0j.asm:16:14: error: invalid operand for instruction
; fmul d4, d4, [x3]
;              ^
; 
; ; Linker error: None
...
fmul d4, d4, [x3]         // Multiply d4 with *outDouble, result in d4
str d4, [x3]              // Store d4 to the address in x3 (outDouble)
