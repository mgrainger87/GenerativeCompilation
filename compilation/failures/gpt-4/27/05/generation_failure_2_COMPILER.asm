...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1chm7669.asm:20:1: error: too few operands for instruction
; fmul d5, d2, v0
; ^~~~~~~~~~~~~~~
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1chm7669.asm:21:1: error: too few operands for instruction
; fmul d2, d5, v1
; ^~~~~~~~~~~~~~~
; 
; ; Linker error: None
...
fmul d2, d5, v1            // Multiply d5 by double2, result in d2
