...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpxyuy170g.asm:20:1: error: too few operands for instruction
; fmul d5, d2, v0
; ^~~~~~~~~~~~~~~
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpxyuy170g.asm:21:1: error: too few operands for instruction
; fmul d6, d5, v1
; ^~~~~~~~~~~~~~~
; 
; ; Linker error: None
