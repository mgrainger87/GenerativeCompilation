...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpvcsv9lf4.asm:20:1: error: too few operands for instruction
; fmul d5, d2, v0
; ^~~~~~~~~~~~~~~
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpvcsv9lf4.asm:21:1: error: too few operands for instruction
; fmul d6, d5, v1
; ^~~~~~~~~~~~~~~
; 
; ; Linker error: None
...
fmul d5, d2, v0            // Multiply d2 (current *outDouble) by double1, result in d5
fmul d6, d5, v1            // Multiply result from previous step (d5) by double2, result in d6
