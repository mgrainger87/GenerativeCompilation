...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1d0lhoxl.asm:20:1: error: too few operands for instruction
; fmul d2, d2, v0
; ^~~~~~~~~~~~~~~
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1d0lhoxl.asm:21:1: error: too few operands for instruction
; fmul d2, d2, v1
; ^~~~~~~~~~~~~~~
; 
; ; Linker error: None
...
fmul d2, d2, v0            // Multiply d2 by double1
fmul d2, d2, v1            // Multiply d2 by double2
