...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmppmoo6894.asm:17:9: error: expected compatible register, symbol or integer in range [0, 4095]
; cmp w4, x0
;         ^
; 
; ; Linker error: None
...
_loop_start:
// Check if loop counter (w4) is greater than int1 (x0)
cmp w4, x0                // Compare w4 with x0
bgt _loop_end             // If w4 > x0, branch to loop end
