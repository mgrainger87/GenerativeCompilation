...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpwljhmd7p.asm:19:10: error: invalid operand for instruction
; fsub v2, v0, v1
;          ^
; 
; ; Linker error: None
...
// Subtract double2 from double1 using a temporary register (v2)
fsub v2, v0, v1
// Store the result to *outDouble (x3 points to outDouble)
str d2, [x3]
