; compiler_errors=8,linker_errors=0,execution_errors=1,correctness_errors=0
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp_a96_3hs-695e95.s:18:1: error: conditional branch requires assembler-local label. 'L_error' is external.
; cbz x3, L_error ; If x3 (outDouble pointer) is null, branch to error label
; ^
; 
; ; Linker error: None
...
blt L_if_true                 ; If double1 < 10, branch to the if block
...
b L_end                       ; Branch to end of function
L_if_true:                        ; Local label for the if block
mul w4, w0, w1                ; w4 = int1 * int2
str w4, [x2]                  ; *outInt = w4
str d0, [x3]                  ; *outDouble = double1
L_end:                            ; Local label for the end of function
...
.LD64_2:
.double 1.0
L_error:                          ; Local label for error handling
