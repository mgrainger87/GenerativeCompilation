; compiler_errors=0,linker_errors=0,execution_errors=4,correctness_errors=2
; ; Compiler error: None
; ; Linker error: None
...
mov x29, sp
// Check if outInt pointer in x3 is non-null
cbnz x3, check_outDouble

// Invalid outInt pointer, return early
b end
check_outDouble:
// Check if outDouble pointer in x4 is non-null
cbnz x4, store
