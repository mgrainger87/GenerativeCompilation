; compiler_errors=3,linker_errors=3,execution_errors=1,correctness_errors=0
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmplor8f54u.asm:23:6: error: invalid operand for instruction
; fmul x26, x22, x23
;      ^
; 
; ; Linker error: None
