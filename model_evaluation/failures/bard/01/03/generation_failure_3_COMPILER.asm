...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpqx_opv2h.asm:21:11: error: invalid operand for instruction
; str x19, [outInt]
;           ^
; /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmpqx_opv2h.asm:24:1: error: unrecognized instruction mnemonic
; stfd d0, [outDouble]
; ^
; 
; ; Linker error: None
