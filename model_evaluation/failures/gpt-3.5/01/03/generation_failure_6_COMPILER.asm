...
; ; Compiler error: /var/folders/nj/t3fv98pd0kldbblbczs56jfh0000gn/T/tmp1wejwpng.asm:16:9: error: invalid operand for instruction
; and sp, sp, #~0xF
;         ^
; 
; ; Linker error: None
...
// Ensure stack pointer (SP) is aligned to 16 bytes.
and sp, sp, #~0xF
